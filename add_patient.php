...
<div class="container">
  ...
  <div class='alert alert-info'>
    <strong>Info!</strong> Appointment will be booked only for today -
    <? echo date("d/m/y"); ?> Appointment time will be between 10:30 to 3:30 or 4:30 to 9:30 once appointment is booked.</div>
